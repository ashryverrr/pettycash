          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <div class="box-body">
                 <form class="form-horizontal" method="POST" action="../admin/cc-report.php">
                    <div class="box-body">
                    <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                      <input type="date" name="cc_date_start_rep" class="form-control" required>
                     </div>                
                    </div>
                    </div>
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <input type="date" name="cc_date_end_rep" class="form-control" required>
                      </div>                
                     </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" name="" value="<?php  echo $username; ?>" readonly>
                       <input type="hidden" class="form-control" name="employee_report" value="<?php  echo $emp_id; ?>">
                      </div>                
                     </div>
                    </div>
                  </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <div class="box-body">
                 <form class="form-horizontal" method="POST" action="../admin/petty-cash-report.php">
                    <div class="box-body">
                    <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                      <label for="customer" class="control-label col-md-4"> Date Start: </label>
                      <div class="col-md-6">
                      <input type="date" name="pc_date_start" class="form-control" required>
                     </div>                
                    </div>
                    </div>
                    <div class="col-md-6">
                      ...
                      <label for="email" class="control-label col-md-4"> Date End: </label>
                      <div class="col-md-6">
                        <input type="date" name="pc_date_end" class="form-control" required>
                      </div>                
                     </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                       <input type="text" class="form-control" name="" value="<?php  echo $username; ?>" readonly>
                       <input type="hidden" class="form-control" name="pc_employee" value="<?php  echo $emp_id; ?>">
                      </div>                
                     </div>
                    </div>
                  </div>
