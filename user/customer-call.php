        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-body">                
                  <table class="table table-bordered table-striped" id="cc-grid">
                    <thead>
                      <tr>
                          <th> CC#  </th>
                          <th> CLIENT </th>
...
$(document).ready(function() {
        var dataTable = $('#cc-grid').DataTable( {
          "processing": true,
          "serverSide": true,
          "paging": true,          
          "ordering": true,
          ...
          "order": [[ 0, "desc" ]],
          "ajax":{
            url :"fetch_customer_call.php", // json datasource
            type: "GET",  // method  , by default get
            error: function(){  // error handling
              $(".cc-grid-error").html("");
              $("#sample-grid").append('<tbody class="cc-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
              $("#cc-grid_processing").css("display","none");
            }
          }
        } );
} );
