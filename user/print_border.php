...
//try {
	...
	echo "<div class='row' style='border-top: solid; border-bottom: solid; '>
			<b>
			<div class='col-xs-3'>
			 VEHICLE
			</div>
	...
	echo "<div class='row' style='border-bottom: thin; border-width: 2px; '> </div>";
	...
	echo "<div class='row' style='border-bottom: solid; '> </div>";
