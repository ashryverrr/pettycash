<?php
  ...
  $k_id = $_GET['id'];
  $sql = "SELECT * FROM transaction WHERE trans_id = :transid AND emp_id = :uid";
...
<head>
  ...
  <title id="doNOTprint">Cyber Frontier | Dashboard</title>
        ...
        <div class="panel panel-default">
          ...
          <table class="table table-bordered table-condensed no-spacing" cellspacing="0">
            ...
            #IF WALANG DETAILS
              ...
              echo "
              <tr>
                <td colspan=3 class='text-center'> <h3> No details available. To add click <a href='edit-petty-cash.php?id=$k_id'>here</a>. </h3> </td>
              </tr>
               ";
            echo "
              <tr>
