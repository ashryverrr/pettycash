<?php
  ...
  $k_id = $_GET['id'];
  $sql = "SELECT ccr_user_id, ccr_cc_num, ccr_client, ccr_date,
  ...
  while ($row = $stmt -> fetch(PDO::FETCH_ASSOC) ) {
    ...
    $sqll = "SELECT client_address, client_account FROM clients
    ...
    $account = $address_row['client_account'];
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="panel-body">
          ...
          <table class="table table-bordered table-condensed no-spacing" cellspacing="0">
            ...
            <?php
              ...
              $k_id = $_GET['id'];
              $counter = "SELECT * FROM cc_report_info WHERE ccr_report_id = :k_id ";
