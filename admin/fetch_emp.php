...
if (empty($search_field)) {
   $sql = "SELECT user_id, emp_name, user_role  FROM users ORDER BY emp_name ASC LIMIT $position, $item_per_page";
   $sql = $pdo -> prepare($sql);
 ...
 $sql = "SELECT user_id, emp_name, user_role FROM users WHERE emp_name LIKE concat('%', :emp_name, '%') ORDER BY emp_name ASC LIMIT $position, $item_per_page ";
 $sql = $pdo -> prepare($sql);
