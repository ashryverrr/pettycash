          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
                  <table class="table table-striped table-bordered" style="white-space: nowrap;" cellspacing="0" width="100%" id="activity-grid">
...
$(document).ready(function() {
        var dataTable = $('#activity-grid').DataTable( {
          "processing": true,
          "serverSide": true,
          "paging": true,
          "ordering": true,
      ...
      if(confirm("Are you sure you want to delete this?")){
           $.ajax({
            ...
            success: function(data){
               ...
               } if (data.status == 'doesnot'){
                 alert("Activity Report does not exist!");
                 window.location.reload(true);
               } else {
