                              ...
                              if ($count > 0) {     
                               ...
                               while($row = $stmt -> fetch(PDO::FETCH_ASSOC)){
                                ...
                                $ccr_serial = trim($row['ccr_serial']);
                                  ...
                                  <td> <input class='form-control input' type='number' name='ccr_amt[]' id='ccr_amt$i' min='0' value='$ccr_amt' onchange='updateTotal();'>  </td>     
                         ...
                         <div class="col-md-4">
                          <div class="form-group">
                           ...
                           <div class="col-md-2">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" name="ccr_rr" id="ccr_rr" value="<?php echo trim($rr_number); ?>" onkeyup="updateTotal();"> 
                            </div>                
                           </div>
                           </div>
                           <div class="col-md-6">
...
$(document).on('click', '.try', function(){  
           ...
           var deductVal = document.getElementById("ccr_amt"+button_id).value;
           var newTotal = oldTotal - deductVal;
         ...
         $.ajax({  
                ...
                success:function(data){
                     if (data.status == 'success'){
                         ...
                         $('#cc_rep')[0].reset();  
                         location.replace("customer-calls.php");
